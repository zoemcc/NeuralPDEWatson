...
#begin
    ...
    adaloss = NeuralPDE.MiniMaxAdaptiveLoss(20; α_pde=1e-1, α_bc=1e2, pde_weights_start=1e-3, bc_weights_start=1e3)
    data_dir = "/home/zobot/.julia/dev/NeuralPDEWatson/data"
    exp_name = "minimax_consistent_largerdomain_onlyc_s_p_adam"
